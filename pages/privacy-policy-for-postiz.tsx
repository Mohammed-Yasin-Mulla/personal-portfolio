...
export default function PrivacyPolicy() {
  return (
    <>
      <Head>
        <title>Privacy Policy - Postiz Instagram Integration</title>
        <meta
          name="description"
          content="Privacy Policy for Postiz Instagram Integration by Mohammed Yasin Mulla"
        />
      ...
      >
        ...
        <p>
          ...
          interacting with your Instagram content through Postize. This
          includes:
        </p>
        <ul>
        ...
        <p>
          ...
          app after any changes constitutes your agreement to the revised
          policy.
        </p>
